<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100 shadow"
    ...
    <a href="{{ route('admin.dashboard') }}"
        ...
        <div class="bg-primary rounded p-2 me-3 shadow-sm d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto gap-1">
        ...
        <li class="mt-4 mb-2">
            <small class="text-uppercase text-white-50 ms-3 fw-bold" style="font-size: 10px; letter-spacing: 1px;">Shortcuts</small>
        </li>
    ...
    <div class="dropdown">
        <a href="#"
            ...
            <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&background=6366f1&color=fff&bold=true" 
                 width="32" height="32" class="rounded-circle me-2 border border-2 border-dark shadow-sm">
...
<style>
    ...
    .hover-white { transition: all 0.2s; color: rgba(255,255,255,0.7); }
    .hover-white:hover {
    ...
    .hover-bg-dark-light { transition: background 0.2s; }
    .hover-bg-dark-light:hover {
        background: rgba(255, 255, 255, 0.08);
    }
    
    .nav-link.active {
        background: linear-gradient(135deg, #4f46e5 0%, #6366f1 100%) !important; /* Gradient Ungu */
        border: none;
    }
</style>